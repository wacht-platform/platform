...
use crate::application::{b2b_query as b2b_query_app, response::ApiResult};
...
) -> ApiResult<crate::application::response::PaginatedResponse<WorkspaceRole>> {
    let roles = b2b_query_app::get_workspace_roles(
        &app_state,
        deployment_id,
        params.workspace_id,
    )
...
) -> ApiResult<crate::application::response::PaginatedResponse<OrganizationRole>> {
    let roles = b2b_query_app::get_organization_roles(
        &app_state,
        deployment_id,
...
pub async fn get_organization_list(
    ...
    let organizations =
        b2b_query_app::get_organization_list(&app_state, deployment_id, query_params).await?;
...
pub async fn get_workspace_list(
    ...
    let workspaces =
        b2b_query_app::get_workspace_list(&app_state, deployment_id, query_params).await?;
    Ok(workspaces.into())
}
...
pub async fn get_workspace_details(
    ...
    let workspace =
        b2b_query_app::get_workspace_details(&app_state, deployment_id, params.workspace_id)
            .await?;
    Ok(workspace.into())
}
...
pub async fn get_organization_members(
    ...
    let members = b2b_query_app::get_organization_members(
        &app_state,
        params.organization_id,
        offset,
        limit,
...
pub async fn get_workspace_members(
    ...
    let members = b2b_query_app::get_workspace_members(
        &app_state,
        params.workspace_id,
        offset,
        limit,
