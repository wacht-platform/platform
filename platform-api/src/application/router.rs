...
fn deployment_routes() -> Router<HttpState> {
    let routes = Router::new()
        ...
        // Billing routes
        .route("/billing", get(api::deployment::billing::get_billing_dashboard))
        .route("/billing/stripe/connect", post(api::deployment::billing::initiate_stripe_connect))
        .route("/billing/stripe/account", get(api::deployment::billing::get_stripe_account_status))
        .route("/billing/stripe/account", delete(api::deployment::billing::disconnect_stripe_account))
        .route("/billing/stripe/dashboard-url", get(api::deployment::billing::get_stripe_dashboard_url))
        .route("/billing/plans", get(api::deployment::billing::get_billing_plans))
        .route("/billing/plans", post(api::deployment::billing::create_billing_plan))
        .route("/billing/plans/{plan_id}", get(api::deployment::billing::get_billing_plan_by_id))
        .route("/billing/plans/{plan_id}", patch(api::deployment::billing::update_billing_plan))
        .route("/billing/plans/{plan_id}", delete(api::deployment::billing::delete_billing_plan))
        .route("/billing/subscriptions", get(api::deployment::billing::get_subscriptions))
        .route("/billing/subscriptions", post(api::deployment::billing::create_subscription))
        .route("/billing/subscriptions/{subscription_id}", get(api::deployment::billing::get_subscription_by_id))
        .route("/billing/subscriptions/{subscription_id}", patch(api::deployment::billing::update_subscription))
        .route("/billing/subscriptions/{subscription_id}", delete(api::deployment::billing::cancel_subscription))
