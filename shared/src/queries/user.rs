    ...
    async fn execute(&self, app_state: &AppState) -> Result<Self::Output, AppError> {
        ...
        let email_addresses = email_rows
            ...
            .map(|row| UserEmailAddress {
                ...
                verification_strategy: row
                    .verification_strategy
                    .and_then(|s| crate::models::VerificationStrategy::from_str(&s).ok())
                    .unwrap_or(crate::models::VerificationStrategy::Otp),
            })
            .collect();
        ...
        let social_connections = social_rows
            ...
            .map(|row| SocialConnection {
                ...
                provider: crate::models::SocialConnectionProvider::from_str(&row.provider)
                    .unwrap_or(crate::models::SocialConnectionProvider::GoogleOauth),
        ...
        let user_details = UserDetails {
            ...
            second_factor_policy: crate::models::SecondFactorPolicy::from_str(
                &user_row.second_factor_policy,
            )
            .unwrap_or(crate::models::SecondFactorPolicy::Optional),
